    ...
    <main>
      ...
      <section className="home-warranty shell" aria-labelledby="home-warranty-title">
        <div className="home-warranty-copy">
          ...
          <div><Link className="button button-primary" href="/bao-hanh">Tra cứu bảo hành</Link><Link className="button button-secondary" href="/tai-khoan">Mở Infinity Company Member</Link></div>
        </div>
      ...
      <section className="section shell" id="map">
        <div className="section-heading">
          <div>
            ...
            <h2>Bản đồ tới Infinity Company</h2>
          </div>
        </div>
        <div className="store-map">
          <iframe
            title="Bản đồ Infinity Company"
