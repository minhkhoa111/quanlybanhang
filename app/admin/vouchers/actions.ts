...
export async function toggleVoucherAction(formData: FormData) { await requireAdminAction(); await setVoucherActive(value(formData, "id"), value(formData, "active") === "true"); revalidatePath("/admin/vouchers"); }
export async function deleteVoucherAction(formData: FormData) { await requireAdminAction(); await deleteVoucher(value(formData, "id")); revalidatePath("/admin/vouchers"); }
