...
export const CHATBOT_KNOWLEDGE: Record<ChatIntent, IntentKnowledge> = {
  ...
  products: {
    ...
    response: "Huy Apple hiện có iPhone, iPad, MacBook, Mac mini, Mac Studio, iMac, Samsung, Android khác và Laptop Windows. Bạn hãy nhập tên model để mình tìm đúng sản phẩm, giá và cấu hình đang có.",
  },
  product_price: {
  ...
  shipping: {
    ...
    response: "Huy Apple hỗ trợ nhận tại cửa hàng, giao hỏa tốc nội thành TP.HCM và giao tiêu chuẩn qua Viettel Post, J&T Express hoặc SPX. Thời gian và phí được xác nhận theo địa chỉ trước khi gửi.",
  },
  payment: {
  ...
  store_information: {
    ...
    response: "Cửa hàng Huy Apple tại 122/4 Cô Giang, P. Cầu Kiệu, TP.HCM. Bạn nên liên hệ trước để cửa hàng xác nhận giờ phục vụ và tồn kho.",
  },
  contact: {
  ...
  goodbye: {
    ...
    response: "Chào bạn. Huy Apple luôn sẵn sàng hỗ trợ khi bạn cần tìm máy hoặc kiểm tra đơn hàng.",
  },
  unknown: {
    phrases: [],
    keywords: [],
...
export const CHATBOT_SHIPPING_KNOWLEDGE: ShippingKnowledge[] = [
  {
    ...
    response: "Có. Huy Apple hỗ trợ giao hỏa tốc trong ngày tại khu vực nội thành TP.HCM sau khi xác nhận đơn và tồn kho. Thời gian cụ thể phụ thuộc địa chỉ, thời điểm đặt hàng và tình trạng tài xế; nhân viên sẽ báo thời gian cùng phí trước khi giao.",
  },
  {
    id: "delivery_time",
  ...
  },
  {
    ...
    response: "Có, Huy Apple hỗ trợ giao tỉnh qua Viettel Post, J&T Express hoặc SPX. Thời gian thường khoảng 2-5 ngày làm việc, khu vực xa có thể 3-7 ngày. Phí và thời gian cụ thể được xác nhận theo địa chỉ nhận hàng trước khi gửi.",
  },
  {
    id: "fee",
